...
1. Read the design-baseline, slice-batch, accepted-slice, project-profile, workspace, and resource-lease identities; applicable coding-standard sources; candidate base and diff; protected behavior; prior evidence; and open findings. Reject superseded input. Accepted immutable dependency commits, contracts, and evidence are valid inputs. Do not read undeclared artifacts from another slice's workspace or mutate another slice's resources or data.
