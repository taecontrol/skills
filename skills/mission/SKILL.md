...
Worker-context isolation, completion signaling, transcript storage, and compaction belong to the active launcher/harness. Mission supplies roles, contracts, and durable handoffs; it does not recreate those mechanics in tickets or role instructions.
