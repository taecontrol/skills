...
description: Design or revise instructions that agents consume, including skills, AGENTS.md, CLAUDE.md, and referenced agent documentation. Use for routing, structure, context management, and reliable behavior.
---
